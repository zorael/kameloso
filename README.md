...
It is written in [**D**](https://www.dlang.org). A variety of features comes bundled in the form of plugins, and it's very easy to write your own. Any and all ideas welcome. API documentation is [available online](http://kameloso.dpldocs.info/kameloso.html).
