/++
    ...
    `fg` is a foreground colour number (of $(REF IRCColour)) and `bg` is a similar
...
/++
    ...
    Params:
        ...
        fg = Foreground $(REF IRCColour).
        bg = Optional background $(REF IRCColour).
 +/
...
/++
    ...
    $(REF std.array.Appender), and returns the resulting string.
...
/++
    ...
    Overload that doesn't take a string to tint, only the $(REF IRCColour)s to
...
/++
    ...
    Params:
        something = Something $(REF std.conv.text)-convertible to enwrap in bold.
...
/++
    ...
    Params:
        something = Something $(REF std.conv.text)-convertible to enwrap in italics.
...
/++
    ...
    Params:
        something = Something $(REF std.conv.text)-convertible to enwrap in underlined.
...
/++
    ...
    Merely calls $(REF mapColoursImpl) with `No.strip`.
...
/++
    ...
    Merely calls $(REF mapColours) with a `Yes.strip` template parameter.
