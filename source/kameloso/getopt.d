...
/++
 +  Read `kameloso.common.CoreSettings` and `lurk.common.IRCClient` from file
 ...
 +
 +  Params:
 +      client = Reference `lurk.common.IRCClient` to apply changes to.
...
/++
 ...
 +      client = Reference to the current `lurk.common.IRCClient`.
