...
@(ChannelPolicy.home)
@BotCommand(PrefixPolicy.requiredNickname, "addmode")
...
@(PrivilegeLevel.admin)
@(ChannelPolicy.home)
@BotCommand(PrefixPolicy.requiredNickname, "clearmodes")
@BotCommand(PrefixPolicy.requiredNickname, "delmodes")
...
@(PrivilegeLevel.admin)
@(ChannelPolicy.home)
@BotCommand(PrefixPolicy.requiredNickname, "printmodes")
...
@(ChannelPolicy.home)
@BotCommand(PrefixPolicy.requiredNickname, "hello")
@BotCommand(PrefixPolicy.requiredNickname, "op")
