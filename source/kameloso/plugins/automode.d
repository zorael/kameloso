...
/++
    ...
    Params:
        plugin = The current $(REF AutomodePlugin).
 +/
...
/++
    ...
    Different $(REF dialect.defs.IRCEvent.Type)s have to be handled differently,
...
/++
    ...
    $(REF applyAutomodes) will cautiously probe whether there are any definitions to
...
/++
    ...
    The $(REF kameloso.plugins.common.core.PrivilegeLevel.anyone) annotation is to
...
private:
    ...
    /++
        ...
        to doing nothing when $(REF AutomodeSettings.enabled) is false.
