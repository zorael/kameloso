...
@BotCommand(PrefixPolicy.requiredNickname, "say")
@BotCommand(PrefixPolicy.requiredNickname, "säg")
@BotCommand(PrefixPolicy.requiredNickname, "echo")
...
@BotCommand(PrefixPolicy.requiredNickname, "8ball")
...
@(IRCEvent.Type.CHAN)
@(PrivilegeLevel.whitelist)
@BotCommand(PrefixPolicy.requiredNickname, "help")
