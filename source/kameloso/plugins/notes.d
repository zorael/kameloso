...
@(ChannelPolicy.home)
@BotCommand(PrefixPolicy.requiredNickname, "printnotes")
...
@(PrivilegeLevel.admin)
@(ChannelPolicy.home)
@BotCommand(PrefixPolicy.requiredNickname, "reloadnotes")
...
@(PrivilegeLevel.admin)
@(ChannelPolicy.home)
@BotCommand(PrefixPolicy.requiredNickname, "fakejoin")
